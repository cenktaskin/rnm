...
# This program calibrates RGB  and IR images separately and then does stereocalibration where
# we get the rotation and translation matrix of rgb camera with respect to ir camera
...
# Stereo-calibrating rgb camera with ir camera to get the rgb to IR transformation.
